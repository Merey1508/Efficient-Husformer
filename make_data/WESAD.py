...
def data_ready(pkl2):
    modality1 = pkl2[b'signal'][b'chest'][b'EDA'] #700
    modality2 = pkl2[b'signal'][b'wrist'][b'BVP'] #64
    modality3 = pkl2[b'signal'][b'chest'][b'EMG'] #700
    modality4 = pkl2[b'signal'][b'chest'][b'ECG'] #700
    modality5 = pkl2[b'signal'][b'chest'][b'Resp'] #700
    modality6 = pkl2[b'signal'][b'wrist'][b'EDA'] #4
...
if __name__ == '__main__':
    txt1 = open('file_paths.txt','r').readlines()
    modality11 = []
    modality21 = []
    modality31 = []
    modality41 = []
    ...
    WESAD(indices,indices.shape[0],modality11,modality21,modality31,modality41,modality51,modality61,label1)
