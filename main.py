...
# Architecture
parser.add_argument('--c_layers', type=int, default=5,
                    help='number of layers in the network (default: 5)')
parser.add_argument('--d_m', type=int, default=30,
                    help='number of layers in the network (default: 5)')
parser.add_argument('--c_heads', type=int, default=5,
                    help='number of heads for the transformer network (default: 5)')
parser.add_argument('--attn_mask', action='store_false',
                    help='use attention mask for Transformer (default: true)')

parser.add_argument('--s_layers', type=int, default=5,
                    help='number of layers in the network (default: 5)')
parser.add_argument('--s_heads', type=int, default=5,
                    help='number of heads for the transformer network (default: 5)')
...
print(train_data.get_n_modalities())
...
hyp_params = args
hyp_params.orig_d_m1, hyp_params.orig_d_m2, hyp_params.orig_d_m3,hyp_params.orig_d_m4,hyp_params.orig_d_m5, hyp_params.orig_d_m6 = train_data.get_dim()
hyp_params.m1_len, hyp_params.m2_len, hyp_params.m3_len, hyp_params.m4_len, hyp_params.m5_len, hyp_params.m6_len = train_data.get_seq_len()
# hyp_params.layers = args.nlevels
# hyp_params.d_m = args.d_m
...
if __name__ == '__main__':
    if args.eval:
        ...
        test_loss = fixed_train.initiate(hyp_params, train_loader, valid_loader, test_loader)
